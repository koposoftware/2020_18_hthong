...
public class TransactionVO {
	...
	private String transClass; // 구분
	private String memo; 		// 적요
	private String withdrawal; // 출금액
	...
	public String toString() {
		return "TransactionVO [id=" + id + ", accNo=" + accNo + ", startDate=" + startDate + ", endDate=" + endDate
				...
				+ ", transDate=" + transDate + ", transClass=" + transClass + ", memo=" + memo + ", withdrawal="
				+ withdrawal + ", deposit=" + deposit + ", balance=" + balance + ", oppAccNo=" + oppAccNo + ", withSum="
				+ withSum + ", depoSum=" + depoSum + "]";
	}

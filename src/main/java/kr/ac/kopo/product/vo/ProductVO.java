...
public class ProductVO {
	...
	public String toString() {
		return "ProductVO [userId=" + userId + ", accNo=" + accNo + ", baseAccNo=" + baseAccNo + ", livingAccNo="
				+ livingAccNo + ", extraAccNo=" + extraAccNo + ", baseMoney=" + baseMoney + ", livingCost=" + livingCost
				+ ", extraMoney=" + extraMoney + ", totalBudget=" + totalBudget + ", accName=" + accName + ", bankName="
				+ bankName + ", balance=" + balance + ", regDate=" + regDate + ", flag=" + flag + ", autodebitCode="
				+ autodebitCode + ", moneyToLiving=" + moneyToLiving + ", moneyToExtra=" + moneyToExtra
				+ ", dateToLiving=" + dateToLiving + ", dateToExtra=" + dateToExtra + "]";
	}

									...
									<table class="table table-striped table-bordered zero-configuration">
										<thead>
											<tr>
												...
												<th style="width: 35%;">예산명</th>
												<th style="width: 30%;">이체금액</th>
							...
							<div class="row">
								...
								<div class="col">
									<input class="form-control form-control-lg" type="text" id="totalBudget"
										name="totalBudget" placeholder="${ onepickInfo.totalBudget }">
										...
										<thead>
											<tr>
												<th colspan="4"
													...
													예산 <strong style="color: red; font-size: 25px;">${ onepickInfo.totalBudget }</strong>
													원 중 <strong style="color: blue; font-size: 25px;">${ onepickInfo.totalBudget }</strong>
													원 남음
												</th>
											</tr>
											<tr>

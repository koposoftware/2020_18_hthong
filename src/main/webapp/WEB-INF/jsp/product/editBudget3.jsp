					...
					<div class="card card-widget">
						<div class="card-body">
							<div class="row">
								...
								<div class="col">
									<input class="form-control form-control-lg" type="text"
										disabled id="fixed_sum" name="fixedSum"
										value="${ onepickInfo.totalBudget }">
								</div>
							</div>
							<div class="mt-4">
										...
										<tbody id="append-area">
											<c:forEach items="${ budgetList }" var="budget"
												...
												<tr>
													...
													<td>${ budget.budget }<input type="hidden"
									...
									<table
										...
										<tbody>
											<tr>
												...
												<td><input type="text" name="setMoney" id="lSetMoney"
													value="${ autoInfo.moneyToLiving }"></td>
												<td><select name="setDate" class="custom-select"
											...
											<tr>
												...
												<td><input type="text" name="setMoney" id="eSetMoney"
													value="${ autoInfo.moneyToExtra }"></td>
												<td><select name="setDate" class="custom-select"

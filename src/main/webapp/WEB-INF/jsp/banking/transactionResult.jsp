...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4">
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="transfer.do">조회</a></li>
								...
								<div class="textarea_wrap">
									...
									<form method="post" name="form">
										...
										<table class="table table-bordered" id="content-table">
											...
											<tbody>
												<c:forEach items="${ transaction }" var="accList"
													varStatus="loop">
													<tr id="tr-con">

														<!-- example -->
														<td rowspan="1"
															style="text-align: center; vertical-align: middle;">${ accList.transDate }</td>
														<td style="text-align: center">${ accList.transClass }</td>
														<td style="text-align: center">${ accList.memo }</td>
														<td style="text-align: center">${ accList.deposit }</td>
														<td style="text-align: center">${ accList.withdrawal }</td>
